    ...
    <div class="row">
      <div class="col-lg-12 mb-4 p-0">
        ...
        <table style="width: 99%">
          ...
          <tbody v-if="searchedKPIs.length > 0">
          <tr>
            <td style="width: 15%">
            ...
            <td style="width: 10%">
              <section v-for="kpi in searchedKPIs" v-bind:key="kpi">
                <p style="margin: 20px 0">
                  ...
                  <router-link :to="'/edit-kpi/' + kpi.uid + '/'">
                    <svg xmlns="http://www.w3.org/2000/svg" class="t-icons" viewBox="0 0 512 512">
                      <path
                  ...
                  <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" style="background-color: transparent; border: none; padding: 0;">
          ...
          <tr>
            <td>
              <p class="text my-3"> There are no KPIs here. </p>
            </td>
          </tr>
          </tbody>
        </table>
