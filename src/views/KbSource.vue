              ...
              <td style="width: 15%">
                <section class="mt-3">
                  <p class="actions">
                    ...
                    <!-- DELETE -->
                    <button v-if="!kpi.default" v-on:click="correctUid(kpi.uid)" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" style="background-color: transparent; border: none; padding: 0;">
                      <svg xmlns="http://www.w3.org/2000/svg" class="t-icons" viewBox="0 0 448 512">
                        <path d="M135.2 17.7L128 32H32C14.3 32 0 46.3 0 64S14.3 96 32 96H416c17.7 0 32-14.3 32-32s-14.3-32-32-32H320l-7.2-14.3C307.4 6.8 296.3 0 284.2 0H163.8c-12.1 0-23.2 6.8-28.6 17.7zM416 128H32L53.2 467c1.6 25.3 22.6 45 47.9 45H346.9c25.3 0 46.3-19.7 47.9-45L416 128z"/>
                      </svg>
                    </button>
                    <!-- enable/disble -->
                    <button v-if="kpi.enabled" v-on:click="correctUid(kpi.uid)" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal2" style="background-color: transparent; border: none; padding: 0;">
                      <svg xmlns="http://www.w3.org/2000/svg" class="t-icons" viewBox="0 0 320 512">
                        <path d="M48 64C21.5 64 0 85.5 0 112V400c0 26.5 21.5 48 48 48H80c26.5 0 48-21.5 48-48V112c0-26.5-21.5-48-48-48H48zm192 0c-26.5 0-48 21.5-48 48V400c0 26.5 21.5 48 48 48h32c26.5 0 48-21.5 48-48V112c0-26.5-21.5-48-48-48H240z"/>
                      </svg>
                    </button>
                    <button v-else type="button" v-on:click="correctUid(kpi.uid)" data-bs-toggle="modal" data-bs-target="#exampleModal3" style="background-color: transparent; border: none; padding: 0;">
                    ...
                    <div class="modal-dialog" style="border-radius: 16px">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <button type="button" v-on:click="deleteKPI()" data-bs-dismiss="modal" class="primary-btn"> Yes, delete KPI</button>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true">
                    <div class="modal-dialog" style="border-radius: 16px">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <button type="button" class="secondary-btn" data-bs-dismiss="modal"> No </button>
                          <button type="button" v-if="kpi.enabled" v-on:click="calculationKPI()" class="primary-btn"> Yes, disable KPI </button>
                          <button type="button" v-else v-on:click="calculationKPI()" data-bs-dismiss="modal" class="primary-btn"> Yes, enable KPI</button>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModalLabel3" aria-hidden="true">
                    <div class="modal-dialog" style="border-radius: 16px">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <button type="button" class="secondary-btn" data-bs-dismiss="modal"> No </button>
                          <button type="button" v-on:click="calculationKPI()" data-bs-dismiss="modal" class="primary-btn"> Yes, enable KPI</button>
                        </div>
                      </div>
                    </div>
                  </div>
...
export default {
  ...
  methods: {
    ...
    async deleteKPI() {
      await axios.delete(BASE_URL + 'kpi/' + this.uid + '/', {
        headers: {
    ...
    async calculationKPI() {
      await axios.put(BASE_URL + 'toggle_kpi/' + this.uid + '/', {}, {
        headers: {
          withCredentials: 'true',
          'Authorization': 'Basic ' + btoa('smartapp' + ':' + 'api'),
        }
